...
class Anexosinfopyme extends Modules {
	//Always declare the module name here
	protected $module = 'Anexosinfopyme';
	...
	*/
	public function getSimpleWidgetList() {
		...
		$widget = array(
			"rawname" => "anexosinfopyme", //Module Rawname
			"display" => _("UCP Module anexosinfopyme"), //The Widget Main Title
	...
	*/
	function getUserSettingsDisplay() {
		...
		return array(
			array(
				"rawname" => "anexosinfopyme", // Module rawname
				"name" => _("anexosinfopyme Settings"), //The Tab's Title
